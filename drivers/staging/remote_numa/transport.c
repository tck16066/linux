...
printk("ADDED COOKIE %llu", main_pg_cookie);
pr_info("added xfer: key=%llx table=%px\n",
        main_pg_cookie, &xfer_table[0]);
...
printk("SENDING COOKIE CRISP %llu", alloc->main_pg_cookie);
